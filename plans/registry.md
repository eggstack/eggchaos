...
| M007 | `007-eggfetch-inprocess-integration.md` | active | M005 | Eggfetch public Dialer, physical-stream policy, direct dialing, and redaction/TLS qualification are in progress. |
