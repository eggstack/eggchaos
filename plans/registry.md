...
| M008 | `008-qualification-release-and-distribution.md` | ready | M006, M007 | M006 and M007 are closed; activate the first release gate for full qualification, packaging, and distribution evidence. |
...
M008 is ready for handoff; no later milestone is activated until its release gate closes.
